...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| 01-01-01 | 01 | 1 | PLAN-01 | T-01-01 / T-01-02 | Contract tests reject blank run/coordinator fields, malformed task fields, unsafe generated IDs, and mismatched root-message decomposition instructions before writer logic is added | unit | `go test ./internal/session -run 'TestRunRequestValidation|TestChildTaskValidation|TestCoordinatorPathsStayInsideStateDir|TestRunRootMessageContract' -count=1` | ❌ W0 | ⬜ pending |
| 01-01-02 | 01 | 1 | PLAN-02 | T-01-02 / T-01-04 | Canonical schema and path helpers preserve required fields, root-message contract inputs, and deterministic `coordinator/runs/...` layout | unit | `go test ./internal/session -run 'TestRunRequestValidation|TestChildTaskValidation|TestCoordinatorPathsStayInsideStateDir|TestRunRootMessageContract' -count=1` | ❌ W0 | ⬜ pending |
